...
// export all action types, which will be used by actions.js
...
export const GET_CONFIRMED_EVENTS = 'GET_CONFIRMED_EVENTS';
export const GET_UNCONFIRMED_EVENTS = 'GET_UNCONFIRMED_EVENTS';
